...
Shader "Toony Colors Pro 2/User/HUE"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		// Shader Properties
		TCP2_TEX2D_WITH_SAMPLER(_MainTex1);
		...
		void vertex_surface(inout appdata_tcp2 v, out Input output)
		{
			...
			// Texture Coordinates
			output.texcoord0.xy = v.texcoord0.xy * _MainTex1_ST.xy + _MainTex1_ST.zw;
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			float4 __albedo = ( ApplyHSV_4(TCP2_TEX2D_SAMPLE(_MainTex1, _MainTex1, input.texcoord0.xy).rgba, _albedo_hue, _albedo_sat, _albedo_val) );
